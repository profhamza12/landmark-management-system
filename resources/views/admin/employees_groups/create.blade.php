            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <a href="">{{trans('content.employees_groups')}}</a> -
                        <span>{{trans('content.addGroup')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="add-group" action="{{route('employees_groups.store')}}" method="POST" enctype="application/x-www-form-urlencoded">
                        @csrf
                        <div class="row tap">
