            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.editEmployee')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="edit-employee" action="{{route('employees.update', $employee->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row tap">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="employee[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterEmployeeName')}}" value="{{@$translations['name'][$lang->abbr]}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="employee[address][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterEmployeeAddress')}}" value="{{@$translations['address'][$lang->abbr]}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="employee[governorate][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterEmployeeGovernorate')}}" value="{{@$translations['governorate'][$lang->abbr]}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="employee[position][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterEmployeePosition')}}" value="{{@$translations['position'][$lang->abbr]}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="employee[qualification][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterQualification')}}" value="{{@$translations['qualification'][$lang->abbr]}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" placeholder="{{trans('content.enterEmployeePhone')}}" value="{{@$employee->phone}}">
                                    @error('phone')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="salary" class="form-control" placeholder="{{trans('content.enterSalary')}}" value="{{@$employee->salary}}">
                                    @error('salary')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="target" class="form-control" placeholder="{{trans('content.enterTarget')}}" value="{{@$employee->target}}">
                                    @error('target')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="commission" class="form-control" placeholder="{{trans('content.enterCommission')}}" value="{{@$employee->commission}}">
                                    @error('commission')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="national_id" class="form-control" placeholder="{{trans('content.enterNationalId')}}" value="{{@$employee->national_id}}">
                                    @error('national_id')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="insurance_number" class="form-control" placeholder="{{trans('content.enterInsuranceNumber')}}"  value="{{@$employee->insurance_number}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="created_at" class="form-control"  value="{{@$employee->created_at}}">
                                    @error('created_at')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="gender" class="form-select">
                                        ...
                                        <option value="1" @if($employee->gender == 1) selected @endif>{{trans('content.male')}}</option>
                                        <option value="0" @if($employee->gender == 0) selected @endif>{{trans('content.female')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="groups[]" class="form-select" multiple>
                                        ...
                                        @foreach($groups as $group)
                                            <option value="{{$group->id}}" @if (in_array($group->id, $employee_groups)) selected @endif>{{$group->display_name}}</option>
                                        @endforeach
                                    </select>
                                    @error('groups')
                                    <small class="text-danger">{{$message}}</small>
