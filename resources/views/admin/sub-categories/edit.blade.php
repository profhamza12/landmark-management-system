            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.editSubCat')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="edit-subCat" action="{{route('sub-categories.update', $subCat->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @isset($languages)
                            <div class="row tap">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="subcat[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterSubCatName')}}" value="{{@$translations['name'][$lang->abbr]}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="subcat[description][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterSubCatDescription')}}" value="{{@$translations['description'][$lang->abbr]}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mainCat" class="form-select">
                                        ...
                                        @foreach($mainCats as $mainCat)
                                            <option value="{{$mainCat->id}}" @if($subCat->MainCategory->id == $mainCat->id) selected @endif>{{$mainCat->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="subCat" class="form-select">
                                        ...
                                        @foreach($subCats as $cat)
                                            @if($subCat->id != $cat->id)
                                                <option value="{{$cat->id}}"
                                                        @isset($subCat->parentSubCategory)
                                                        @if($subCat->parentSubCategory->id == $cat->id)
                                                        selected
                                                    @endif
                                                    @endisset
                                                >{{$cat->name}}</option>
                                ...
                                <div class="form-group">
                                    <div class="custom-file-upload">
                                        ...
                                        <div class="custom-file">
                                            <div class="sec1">
                                                <span>{{trans('content.chooseNewSubCatPhoto')}}</span>
                                            </div>
                                            <div class="sec2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group status">
                                    ...
                                    <input type="checkbox" name="active" @if($subCat->active == 1) checked @endif data-toggle="toggle" data-on="{{trans('content.enabled')}}" data-off="{{trans('content.disabled')}}" data-onstyle="success" data-offstyle="danger">
                                </div>
                            </div>
                        </div>
