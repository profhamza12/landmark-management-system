            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.return_invoice')}}</span>
                    </div>
                </div>
            ...
            $customiseData =
                "<div class='payable-custom-data'>\
                    ...
                    <div class='payable-type'>\
                        <span>{{trans('content.sales_invoice') . " / " . $invoice->invoice_id}}</span>\
                    </div>\
                </div>";
            $invoice_price_details =
                "<div class='payable-custom-data'>\
                    ...
                    <div class='payable-discount'>\
                        <span>{{trans('content.return_amount') . " / " . $invoice->return_amount}}</span>\
                    </div>\
                ...
                buttons:  [
                    {
                        "charset": "utf-8",
                        "extend": "print",
                        "title": "{{trans('content.return_invoice')}}",
                        "text": "{{trans('content.print')}}",
                        "filename": "{{trans('content.return_invoice')}}",
                        autoPrint: true,
                        exportOptions: {
                            columns: [ 0, 1, 3, 4, 5 ]
                        },
