            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.editReturnInvoice')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="edit-return-sales-invoice" action="{{route('return_sales_invoices.update', $invoice->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="invoice_id" class="invoice form-select">
                                        ...
                                        @foreach($invoices as $_invoice)
                                            <option value="{{$_invoice->id}}" @if($_invoice->id == $invoice->invoice_id) selected @endif>{{$_invoice->id}}</option>
                                        @endforeach
                                    </select>
                                    @error('invoice_id')
                                    <small class="text-danger">{{$message}}</small>
                        ...
                        <div class="row">
                            <div class="store_quantity">
                                ...
                                @foreach($invoice_items as $index => $_item)
                                    <div class="sec">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="store_quantity[{{$index}}][item]" class="item form-select">
                                                        ...
                                                        @foreach($items as $item)
                                                            <option value="{{$item->id}}" @if($_item->item_id == $item->id) selected @endif>{{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="store_quantity[{{$index}}][unit]" class="unit form-select">
                                                        ...
                                                        @foreach($units as $unit)
                                                            <option value="{{$unit->id}}" @if($small_unit->id == $unit->id) selected @endif>{{$unit->name}}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="store_quantity[{{$index}}][quantity]" class="quantity form-control" placeholder="{{trans('content.enterItemQuantity')}}" min="0" value="{{@$_item->quantity}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="store_quantity[{{$index}}][selling_price]" class="selling_price form-control" readonly value='{{@$invoice->return_amount}}'>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="return_amount" class="return_amount form-control" readonly value="{{@$invoice->return_amount}}">
                                    @error('return_amount')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
