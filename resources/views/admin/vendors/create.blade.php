            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.addVendor')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="add-vendor" action="{{route('vendors.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row tap">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vendor[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterVendorName')}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vendor[address][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterVendorAddress')}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vendor[governorate][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterVendorGovernorate')}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="vendor[position][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterVendorPosition')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="{{trans('content.enterVendorEmail')}}">
                                    @error('email')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" placeholder="{{trans('content.enterVendorPhone')}}">
                                    @error('phone')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="creditor_amount" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="debtor_amount" class="form-control">
                                    @error('debtor_amount')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="invoice_type" class="form-select">
                                        ...
                                        @foreach($invoice_types as $invoice_type)
                                            <option value="{{$invoice_type->id}}">{{$invoice_type->display_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-file-upload">
                                        ...
                                        <div class="custom-file">
                                            <div class="sec1">
                                                <span>{{trans('content.chooseVendorPhoto')}}</span>
                                            </div>
                                            <div class="sec2">
