            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.editStore')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="edit-store" action="{{route('stores.update',$store->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @isset($languages)
                            <div class="row tap">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="store[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterStoreName')}}" value="{{@$translations['name'][$lang->abbr]}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="store[address][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterstoreaddress')}}" value="{{@$translations['address'][$lang->abbr]}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" placeholder="{{trans('content.enterstorePhone')}}" value="{{$store->phone}}">
                                    @error('phone')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="store_keeper" class="form-select">
                                        ...
                                        @foreach($storekeepers as $storekeeper)
                                            <option value="{{$storekeeper->id}}" @if($store->storeKeeper->id == $storekeeper->id) selected @endif>{{$storekeeper->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="company_branch" class="form-select">
                                        ...
                                        @foreach($branches as $branch)
                                            <option value="{{$branch->id}}" @if($store->companyBranch->id == $branch->id) selected @endif>{{$branch->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group status">
                                    ...
                                    <input type="checkbox" name="active" @if($store->active == 1) checked @endif data-toggle="toggle" data-on="{{trans('content.enabled')}}" data-off="{{trans('content.disabled')}}" data-onstyle="success" data-offstyle="danger">
                                </div>
                            </div>
                        </div>
