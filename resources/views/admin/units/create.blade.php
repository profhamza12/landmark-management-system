            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.addUnit')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="add-unit" action="{{route('units.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @isset($languages)
                            <div class="row tap">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="unit[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterUnitName')}}">
