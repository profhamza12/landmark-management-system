            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <a href="">{{trans('content.client_groups')}}</a> -
                        <span>{{trans('content.addClientGroup')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="add-group" action="{{route('clients_groups.store')}}" method="POST" enctype="application/x-www-form-urlencoded">
                        @csrf
                        <div class="row tap">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="group[display_name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterGroupDisplayName')}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="group[description][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterGroupDescription')}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="{{trans('content.enterGroupName')}}">
                                    @error('name')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
