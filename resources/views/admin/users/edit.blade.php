            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.editUser')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="edit-user" action="{{route('users.update', $user->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row tap">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="user[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterUserName')}}" value="{{@$translations['name'][$lang->abbr]}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="user[address][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterUserAddress')}}" value="{{@$translations['address'][$lang->abbr]}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" placeholder="{{trans('content.enterUserEmail')}}" value="{{@$user->email}}">
                                    @error('email')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" placeholder="{{trans('content.enterUserPhone')}}" value="{{@$user->phone}}">
                                    @error('phone')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="gender" class="form-select">
                                        ...
                                        <option value="1" @if($user->gender == 1) selected @endif>{{trans('content.male')}}</option>
                                        <option value="0" @if($user->gender == 0) selected @endif>{{trans('content.female')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-file-upload">
                                        ...
                                        <div class="custom-file">
                                            <div class="sec1">
                                                <span>{{trans('content.chooseNewPhoto')}}</span>
                                            </div>
                                            <div class="sec2">
                                    ...
                                    @foreach($permissions as $permission)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                   ...
                                                   @if($user->hasPermission($permission->name)) checked @endif>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group status">
                                    ...
                                    <input type="checkbox" name="active" @if($user->active == 1) checked @endif data-toggle="toggle" data-on="{{trans('content.enabled')}}" data-off="{{trans('content.disabled')}}" data-onstyle="success" data-offstyle="danger">
                                </div>
                            </div>
                        </div>
