            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.invoice_types')}}</span>
                    </div>
                </div>
                            ...
                            @isset($groups)
                                @foreach($groups as $group)
                                    <tr class="tr_{{$group->id}}">
                                        ...
                                        <td>
                                            <a href="{{route('invoice_types.edit', $group->id)}}" class="btn btn-outline-primary">{{trans('content.edit')}}</a>
                                            <a href="{{route('invoice_types.destroy', $group->id)}}" class="group-delete btn btn-outline-danger" data-id="{{$group->id}}">{{trans('content.delete')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endisset
                ...
                buttons:  [
                    {
                        ...
                        "filename": "{{trans('content.invoice_types')}}",
                        autoPrint: true,
                        exportOptions: {
                            columns: [ 0, 1, 2 ]
                        },
        ...
        $(function () {
            $(".group-delete").click(function (e) {
                ...
                if (window.confirm("{{trans('content.groupdeletepromptmsg')}}"))
                {
                    ...
                    let url = "{{route('invoice_types.destroy', ":id")}}";
