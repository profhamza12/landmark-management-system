            ...
            <div class="row">
                <div class="col-sm-12 page-info">
                    ...
                    <div>
                        ...
                        <span>{{trans('content.editCoin')}}</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-data">
                    ...
                    @endif
                    <form class="" name="edit-coin" action="{{route('coins.update', $coin->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @isset($languages)
                            <div class="row tap">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="coin[name][{{$lang->abbr}}]" class="form-control" placeholder="{{trans('content.enterCoinName')}}" value="{{@$translations['name'][$lang->abbr]}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="symbol" class="form-control" placeholder="{{trans('content.enterCoinSymbol')}}" value="{{@$coin->symbol}}">
                                    @error('symbol')
                                    <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group status">
                                    ...
                                    <input type="checkbox" name="active" @if($coin->active == 1) checked @endif data-toggle="toggle" data-on="{{trans('content.enabled')}}" data-off="{{trans('content.disabled')}}" data-onstyle="success" data-offstyle="danger">
                                </div>
                            </div>
                        </div>
